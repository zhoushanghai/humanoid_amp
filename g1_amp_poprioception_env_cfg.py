...
from .g1_amp_env_cfg import G1AmpDeployEnvCfg
...
@configclass
class G1AmpPoprioceptionEnvCfg(G1AmpDeployEnvCfg):
    """Configuration for the G1 AMP proprioception exploration environment."""
